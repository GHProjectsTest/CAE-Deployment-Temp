...
public class TodoList extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "3", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/GHProjectsTest/microservice-3/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response getTodos() {
    ...
    PreparedStatement s = c.prepareStatement("SELECT * FROM todo_items;"); 
    ResultSet queryResult = s.executeQuery(); 
  
    JSONArray a = new JSONArray();
    while(queryResult.next()) {  
        a.add(queryResult.getString("item_name"));
    } 
  ...
  public Response postTodo(String payload) {
    ...
    PreparedStatement s = c.prepareStatement("INSERT INTO todo_items (item_name) VALUES (?);"); 
