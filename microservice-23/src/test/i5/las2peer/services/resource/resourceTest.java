 ...
 * 23 - Test Class
 *
 * This class provides a basic testing framework for the microservice 23. It was
...
public class resourceTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(resource.class.getCanonicalName(),"0.1");

  private static final String mainPath = "resource";
  ...
  public void testmethod() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/method", payload.toJSONString(),
        MediaType.APPLICATION_JSON, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testmethod': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
