 ...
 * 26 - Test Class
 *
 * This class provides a basic testing framework for the microservice 26. It was
...
public class TodoListTest {
  ...
  public void testpostTodo() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("POST", mainPath + "/todo", payload.toJSONString(),
        MediaType.APPLICATION_JSON, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testpostTodo': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
  ...
  public void testgetTodos() {
    ...
    try {
      ...
      c.setLogin(testAgent.getIdentifier(), testPass);
      ClientResponse result = c.sendRequest("GET", mainPath + "/todo", "",
